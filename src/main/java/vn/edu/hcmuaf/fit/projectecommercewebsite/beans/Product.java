...
public class Product {
    ...
    public Product(String product_id, String product_name, String product_des, int product_price, String iventory_id, String catetory_id, String discount_id, String img_url, Date createAt) {
