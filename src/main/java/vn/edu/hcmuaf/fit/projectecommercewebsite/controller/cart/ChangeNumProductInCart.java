...
@WebServlet(name = "ChangeNumProductInCart", value = "/ChangeNumProductInCart")
public class ChangeNumProductInCart  extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        cart.updateNumProductInCart(product_id,num);
