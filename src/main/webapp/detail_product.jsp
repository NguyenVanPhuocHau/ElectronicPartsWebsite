            ...
            <div class="span9">
                ...
                <div class="row">
                    <div id="gallery" class="span3">
                        <a href="<c:out value="${requestScope.detailProduct.img_url}"/>" title="">
                            <img src="<c:out value="${requestScope.detailProduct.img_url}"/>" style="width:100%"
                                 alt="F<c:out value="${requestScope.detailProduct.product_name}"/>"/>
                        </a>
                        <div id="differentview" class="moreOptopm carousel slide">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="<c:out value="${requestScope.detailProduct.img_url}"/>"> <img style="width:29%"
                                                                                        src="<c:out value="${requestScope.detailProduct.img_url}"/>"
                                                                                        alt=""/></a>
                                    <a href="themes/images/products/large/f2.jpg"> <img style="width:29%"
                                                                                        src="assets/themes/images/products/large/f2.jpg"
                                                                                        alt=""/></a>
                                    <a href="themes/images/products/large/f3.jpg"> <img style="width:29%"
                                                                                        src="assets/themes/images/products/large/f3.jpg"
                                                                                        alt=""/></a>
                                </div>
                                <div class="item">
                                    <a href="themes/images/products/large/f3.jpg"> <img style="width:29%"
                                    ...
                                    <a href="themes/images/products/large/f1.jpg"> <img style="width:29%"
                                                                                        src="assets/themes/images/products/large/f1.jpg"
                                                                                        alt=""/></a>
                                    <a href="themes/images/products/large/f2.jpg"> <img style="width:29%"
                                                                                        src="assets/themes/images/products/large/f2.jpg"
                                                                                        alt=""/></a>
                    ...
                    <div class="span6">
                        <h3><c:out value="${requestScope.detailProduct.product_name}"/></h3>
...
<%--                        </form>--%>
                        <hr class="soft clr"/>
                        <p>
                            Đảm bảo hàng chất lượng, bảo hành 6 tháng.
...
<%--                                    </div>--%>
<%--                                </div>--%>
                                <c:out value="${requestScope.detailProduct.product_des}"/>
                                <br class="clr">
                            </div>
                        </div>
                    </div>
