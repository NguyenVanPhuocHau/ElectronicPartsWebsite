    ...
    <div class="container">
        <div class="row">
            ...
            <div id="socialMedia" class="span3 pull-right">
                <h5>SOCIAL MEDIA </h5>
                <a href="#"><img width="60" height="60" src="assets/themes/images/facebook.png" title="facebook"
                                 alt="facebook"/></a>
                <a href="#"><img width="60" height="60" src="assets/themes/images/twitter.png" title="twitter"
                                 alt="twitter"/></a>
                <a href="#"><img width="60" height="60" src="assets/themes/images/youtube.png" title="youtube"
                                 alt="youtube"/></a>
            </div>
        </div>
