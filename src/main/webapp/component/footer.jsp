        ...
        <div class="container" style="width: 1170px">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                    <section class="footer-item">
                        <h3 class="section-title">Mục nổi bật</h3>
                        <div class="">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="wrap-custom-menu vertical-menu-2">
                                    <ul class="menu">
                                        <li><a href="cacLoaiSanPham.jsp">Linh kiện điện thoại</a></li>
                                        <li><a href="cacLoaiSanPham.jsp">Linh kiện thiết bị</a></li>
                                        <li ><a href="khuyenMai.jsp">Sản phẩm khuyễn mãi</a></li>
                                        <li ><a href="banChay.jsp">Các ản phẩm HOT</a></li>
                                    </ul>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                    <section class="footer-item">
                        <h3 class="section-title">Shop buôn bán linh kiện điện tử uy tín</h3>
                        <div class="contact-info-block footer-layout xs-padding-top-10px">
                            <ul class="contact-lines">
                                <li>
                                    <p class="info-item">
                                        <i class="fa fa-thin fa-house-user" style="font-size: 24px; float: left; width: 36px"></i>
                                        <b class="desc">phường Linh trung, quận Thủ Đức, thành phố HCM</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="fa fa-thin fa-mobile" style="font-size: 24px; float: left; width: 36px"></i>
                                        <b class="desc">số điện thoại: 037 353 5208</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="fa fa-regular fa-envelope" style="font-size: 24px; float: left; width: 36px"></i>
                                        <b class="desc">Email: Organic@company.com</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="fa fa-light fa-clock" style="font-size: 24px; float: left; width: 36px"></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="copy-right-text"><p><a href="">Phương thức thanh toán</a></p></div>
                </div>
                <div class="col-lg-6 col-sm-6 col-xs-12">
